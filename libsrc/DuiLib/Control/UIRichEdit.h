...
public:
	...
	static void CharFormat2LogFont(const CHARFORMAT2 &cf, COLORREF &textcolor, LOGFONT &lf);
	static void LogFont2CharFormat(const LOGFONT &lf, const COLORREF &textcolor, DWORD Flags, CHARFORMAT &cf);
	static void CharFormattoLogFont(const CHARFORMAT &cf, COLORREF &textcolor, LOGFONT &lf);
	void CharFormattoCharFormat2(const CHARFORMAT &cf, CHARFORMAT2 &cf2);
