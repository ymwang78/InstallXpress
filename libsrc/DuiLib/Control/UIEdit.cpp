...
namespace DuiLib
{
	...
	public:
		...
		void Init(CEditUI* pOwner,bool bCenterInput);
		RECT CalPos();
	...
	void CEditWnd::Init(CEditUI* pOwner, bool bCenterInput)
	{
	...
	CEditUI::CEditUI() : m_pWindow(NULL), m_uMaxChar(255), m_bReadOnly(false), m_bInputcenter(false),
	...
	void CEditUI::DoEvent(TEventUI& event)
	{
		...
		if( event.Type == UIEVENT_SETFOCUS && IsEnabled() ) 
		{
			...
			ASSERT(m_pWindow);
			m_pWindow->Init(this, m_bInputcenter);
			Invalidate();
		}
	...
	void CEditUI::SetInputCenter(bool bInputcenter)
	{
