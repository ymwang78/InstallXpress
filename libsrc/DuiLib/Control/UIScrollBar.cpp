...
namespace DuiLib
{
	CScrollBarUI::CScrollBarUI() : m_bHorizontal(false), m_nRange(100), m_nScrollPos(0), m_nLineSize(8), 
		...
		m_uButton2State(0), m_uThumbState(0), m_bShowButton1(true), m_bShowButton2(true),m_bEnabledDraw(true)
	{
	...
	void CScrollBarUI::SetEnabledDraw(bool bEnabledDraw)
	{
	...
	{
		if( !::IntersectRect(&m_rcPaint, &rcPaint, &m_rcItem) || m_bEnabledDraw == false)
			return;
