...
namespace DuiLib
{
	CTextUI::CTextUI() : m_nLinks(0), m_nHoverLink(-1),m_bMouseEvent(false)
	{
	...
	bool CTextUI::IsMouseEvent() const
	{
		return m_bMouseEvent;
	}

	void CTextUI::SetMouseEvent(bool bMouseEvent)
	{
	...
	{
		if (_tcscmp(pstrName, _T("mouseevent")) == 0) SetMouseEvent(_tcscmp(pstrValue, _T("true")) == 0);
