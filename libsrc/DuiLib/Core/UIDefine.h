...
#define DUI_MSGTYPE_DOWNCLICK              (_T("downclick"))
#define DUI_MSGTYPE_UPCLICK				   (_T("upclick"))
...
#define DUI_MSGTYPE_PTRCCLICK			   (_T("ptrcclick"))

#define DUI_MSGTYPE_ITEMSELSCR			   (_T("itemselsrc"))
...
#define DUI_MSGTYPE_ITEMVISIBLE            (_T("itemvisible"))
...
#define DUI_MSGTYPE_MENUCCLICK			   (_T("menuclick"))
#define DUI_MSGTYPE_LISTSCROLL	   		   (_T("listscroll"))
#define DUI_MSGTYPE_LISTHEADEXPAND		   (_T("listheadexpand"))
#define DUI_MSGTYPE_COLORPALETTE		   (_T("colorpalette"))
#define DUI_MSGTYPE_PLAYFINISH			   (_T("itemplayfinish"))

#define DUI_MSGTYPE_WEBCREATER			   (_T("webcreater"))
#define	DUI_MSGTYPE_CLOSEOPTION			   (_T("closeoption"))
//////////////////////////////////////////////////////////////////////////
...
#define  DUI_CTR_LABELICON                       (_T("LabelIcon"))
#define  DUI_CTR_LABELANIM						 (_T("LabelAnim"))
...
#define  DUI_CTR_TREELISTVIEW                    (_T("TreeListView"))
...
#define  DUI_CTR_TREELISTVIEWHEAD				 (_T("TreeListViewHead"))

#define  DUI_CTR_ANIMATIONTABLAYOUT				 (_T("AnimationTabLayout"))

#define  DUI_CTR_LISTCONTAINERELEMENT            (_T("ListContainerElement"))
#define  DUI_CTR_TITLEHORIZONTALLAYOUT			 (_T("TitleHorizontalLayout"))
#define  DUI_CTR_LISTCONTAINERELEMENTEX          (_T("ListContainerElementEx"))
#define  DUI_CTR_TREELISTCONTAINERELEMENT        (_T("TreeListContainerElement"))

#define  DUI_CTR_LISTCONTAINERELEMENTCOMBO        (_T("ListContainerElementCombo"))
///
//////////////END控件名称宏定义//////////////////////////////////////////////////
