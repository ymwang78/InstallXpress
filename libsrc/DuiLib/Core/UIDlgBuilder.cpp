    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            case 9:
				...
				else if (_tcscmp(pstrClass, DUI_CTR_COMBOEDIT) == 0)          pControl = new CComboUIEdit;
				else if (_tcscmp(pstrClass, DUI_CTR_LABELICON) == 0)		  pControl = new CLabelIconUI;
				else if (_tcscmp(pstrClass, DUI_CTR_LABELANIM) == 0)		  pControl = new CLabelAnimUI;
				else if (_tcscmp(pstrClass, DUI_CTR_TABOPTION) == 0)	      pControl = new CTabOptionUI;
                break;
            case 10:
				...
				else if (_tcscmp(pstrClass, DUI_CTR_ICONBUTTON) == 0)		  pControl = new CIconButtonUI;
                break;
			case 11:
				if (_tcscmp(pstrClass, DUI_CTR_CHILDLAYOUT) == 0)			  pControl = new CChildLayoutUI;
				break;
			case 12:
				if (_tcscmp(pstrClass, DUI_CTR_TREELISTVIEW) == 0)			  pControl = new CTreeListViewUI;
            ...
            case 16:
				...
				else if (_tcscmp(pstrClass, DUI_CTR_TREELISTVIEWHEAD) == 0)   pControl = new CTreeListViewHeaderUI;
                break;
			case 18:
            ...
            case 20:
                ...
                break;
			case 21:
				if (_tcscmp(pstrClass, DUI_CTR_TITLEHORIZONTALLAYOUT) == 0)   pControl = new CTitleHorizontalLayoutUI;
				break;
			case 22:
				if (_tcscmp(pstrClass, DUI_CTR_LISTCONTAINERELEMENTEX) == 0)   pControl = new CListContainerElementExUI;
				break;
			case 24:
				if (_tcscmp(pstrClass, DUI_CTR_TREELISTCONTAINERELEMENT) == 0)   pControl = new CTreeListContainerElementUI;
				break;
			case 25:
				if (_tcscmp(pstrClass, DUI_CTR_LISTCONTAINERELEMENTCOMBO) == 0)  pControl = new CListContainerElementComboUI;
				break;
            }
