...
#define UISTATE_EXPANDED	 0x00000080	
	...
	public:
		...
		void SetTransParentHwnd(HWND hwnd);
		...
		CDuiString GetLimitText(LPCTSTR ptext, int nFont, int nMaxlen);
		// 
	...
	private:
		...
		static CStdStringPtrMap m_mImageHash;
