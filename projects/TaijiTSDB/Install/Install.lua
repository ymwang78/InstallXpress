...
function KillProcesses()
	...
	installx.LogPrint("Stop Service HostPy ...")
...
function PostSetup()
    ...
    installx.ProcessExecute("\"" .. _dirCompany .. "\\HostPy\\HostPy.exe\" --install HostPy")
    installx.ProcessExecute("\"" .. _dirCompany .. "\\HostVM\\HostVM.exe\" --start HostVM")
    installx.ProcessExecute("\"" .. _dirCompany .. "\\HostPy\\HostPy.exe\" --start HostPy")
